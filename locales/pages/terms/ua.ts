export default {
  ...
  items: [
    {
      ...
      paragraphs: [
        ...
        'Інтернет-магазин – сайт Продавця за адресою www.letiaga.org створений для укладення договорів роздрібної та оптової купівлі-продажу на підставі ознайомлення Покупця із запропонованим Продавцем описом Товару за допомогою мережі Інтернет.',
        ...
        'Продавець – «Благодійна організація «Благодійний фонд «Летяга» (ідентифікаційний код 45446262), юридична особа, яка створена і діє відповідно до чинного законодавства України, місцезнаходження якої: Україна, м. Львів, вул. Сяйво, буд.13'
      ]
    },
    {
    ...
    {
      heading: 'Ціна і Доставка Товару',
      paragraphs: [
    ...
    {
      heading: 'Права ті обов’язки Сторін',
      paragraphs: [
    ...
    {
      heading: 'Конфіденційність і захист персональних даних.',
      paragraphs: [
  ...
  footerTitle: 'АДРЕСА ТА РЕКВІЗИТИ ПРОДАВЦЯ:',
  name: '«Благодійна організація «Благодійний фонд «Летяга»',
};
